...
<body>
	<div class="col-lg-12">
			...
			<table class="table1">
				...
				<tr>
					<td style="padding-top: 10px;"><input type="password" name="re_pass" id="re_pass" placeholder="Confirm Your Password"></td>
				</tr>

				<tr>
					<td ><button id="change_password" name="change_password" >Change</button></td>
					<?php include("includes/change_password_db.php"); ?>
				</tr>
				</table>
			</form>
